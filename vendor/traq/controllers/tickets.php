    ...
    public function action_new()
    {
        ...
        if (Request::method() == 'post') {
            ...
            if ($this->user->permission($this->project->id, 'ticket_properties_set_assigned_to')) {
                $data['assigned_to_id'] = Request::post('assigned_to', 0);
            }
